...
// Buffer A generates the Transmittance LUT. Each pixel coordinate corresponds
// to a height and sun zenith angle, and the value is the transmittance from
// that point to sun, through the atmosphere.
